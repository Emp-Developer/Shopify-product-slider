...
(function(factory) {
    ...
    $.extend(Plugin.prototype, {
        ...
        nextCard: function(target = "right") {
            if (this._activeCard.index + 1 < this._cards.length) {
                this.changeCardTo(this._activeCard.index + 1, false, target);
            } else if (this.settings.loop) {
                this.changeCardTo(0, true, target);
            }
        },
        prevCard: function() {
        ...
        changeCardTo: function(index, resetZ, target = "right") {
            ...
            if (this.settings.loop) {
                ...
                this._cards.forEach(function(card) {
                    ...
                    card.elem.classList.remove('cardslider--sortback-left');
                    card.elem.classList.remove('cardslider--sortback-right');
            ...
            if (oldCard && (index > oldCard.index || (index < oldCard.index && resetZ)) || !oldCard && index > 0) {
                ...
                if (this.settings.loop && oldCard != null) {
                    ...
                    oldCard.elem.classList.add('cardslider--sortback-' + target);
                }
            } else if (oldCard) {
                if (this.settings.loop && oldCard) {
                    this._cards[indexAbs].elem.classList.remove('cardslider__card--transitions');
                    this._cards[indexAbs].elem.classList.add('cardslider--sortback-' + target);
                }
                this._cards.forEach(function(card) {
